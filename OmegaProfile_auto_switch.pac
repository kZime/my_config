var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)dogfight360\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)androidappsgame\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xmoeproject\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)cnpicacomic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)vjudge\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)internetdownloadmanager\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)etcher\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)shields\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)loli\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)daliansky\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)v2ex\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)artofproblemsolving\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)brilliant\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)aria2c\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)daumpotplayer\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)greasyfork\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)flexio\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)rufus\.ie$/.test(host)) return "+proxy";
        if (/(?:^|\.)datacruiser\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)digitaloceanspaces\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)weglot\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)webflow\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)d3e54v103j8qbb\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)github-production-release-asset-2e65be\.s3\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)starbounder\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)margatroid\.xyz$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)nluug\.nl$/.test(host)) return "+proxy";
        if (/(?:^|\.)apk\.support$/.test(host)) return "+proxy";
        if (/(?:^|\.)githubassets\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)flowstate\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)jupyter\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)reaper\.fm$/.test(host)) return "+proxy";
        if (/(?:^|\.)d29vzk4ow07wi7\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)rime\.im$/.test(host)) return "+proxy";
        if (/(?:^|\.)bintray\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)sijinight\.top$/.test(host)) return "+proxy";
        if (/(?:^|\.)duetdisplay\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)icloud\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)steampowered\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)rus\.ec$/.test(host)) return "+proxy";
        if (/(?:^|\.)raw\.githubusercontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tidal\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)geogebra\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)geekgurldiaries\.co\.uk$/.test(host)) return "+proxy";
        if (/(?:^|\.)pornhubselect\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)python\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)sieuthuthuat\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fandom\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)twrp\.me$/.test(host)) return "+proxy";
        if (/(?:^|\.)clockworkmod\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sharepoint\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)band\.us$/.test(host)) return "+proxy";
        if (/(?:^|\.)origin\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fhyx\.hk$/.test(host)) return "+proxy";
        if (/(?:^|\.)ugetdm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)virtualbox\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)smlnj\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)baikalos\.ru$/.test(host)) return "+proxy";
        if (/(?:^|\.)t\.me$/.test(host)) return "+proxy";
        if (/(?:^|\.)vim\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)kuangbin\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)onenotegem\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)github\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bandwagonhost\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ppy\.sh$/.test(host)) return "+proxy";
        if (/(?:^|\.)upenn\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)realworldhaskell\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)atom\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)haskellbook\.com$/.test(host)) return "+proxy";
